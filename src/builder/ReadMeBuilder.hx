...
class ReadMeBuilder {
	...
	public function build(version:String):String {
		var file = Path.of("README.md").toFile();

		var fileContent = new StringBuf();

		fileContent.add('# hxUI5
...
Generated from Version:\n');
		...
		fileContent.add('$version \n\n');

		fileContent.add('OpenUI5 is under Apache 2 License.
